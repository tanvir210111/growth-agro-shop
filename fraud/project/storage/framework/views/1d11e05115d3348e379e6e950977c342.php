                    ...
                    <div class="d-md-flex justify-content-between align-items-center">
                        <div>
                            <div class="d-flex align-items-center mb-1">
                                <h6 class="fw-bold text-dark mb-0 me-3"><?php echo e($ticket->subject); ?></h6>
                                <span class="status-badge badge-<?php echo e(strtolower($ticket->status)); ?>">
                            ...
                            <div class="text-muted small">
                                ...
                                <?php echo e(\Carbon\Carbon::parse($ticket->created_at)->format('d M, Y h:i A')); ?>

                                <span class="mx-2">|</span>
                                <i class="fa-solid fa-hashtag me-1"></i> Ticket #<?php echo e($ticket->id); ?>

                            </div>
                        </div>
                        <div class="mt-3 mt-md-0">
                            
                            <a href="<?php echo e(route('user.support.view', $ticket->id)); ?>" class="btn btn-outline-primary rounded-pill px-4 btn-sm fw-bold">
                                বিস্তারিত ও রিপ্লাই <i class="fa-solid fa-chevron-right ms-1"></i>
                            </a>
                        </div>
                    </div>
                    <p class="mt-3 text-secondary small mb-0">
                        <?php echo e(Str::limit($ticket->message, 150)); ?>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg rounded-4">
            ...
            <div class="modal-body p-4">
                <form action="<?php echo e(route('user.support.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="mb-3">
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/creativedesignbd/fraud.creativedesign.com.bd/project/resources/views/user/client/support.blade.php ENDPATH**/ ?>