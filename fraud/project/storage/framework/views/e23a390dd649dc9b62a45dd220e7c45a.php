...
<?php $__env->startSection('meta'); ?>
    <title><?php echo e(__('Contact With Us')); ?> - <?php echo e($gs->title); ?></title>
    <meta property="og:title" content="<?php echo e(__('Contact With Us')); ?>" />
    ...
    <section class="page-hero">
        <div class="container">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?php echo e(route('frontend.index')); ?>">হোম</a></li>
                        ...
                        <div class="col-12">
                            <div class="info-card p-4 shadow-sm border-0 d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <p class="small text-muted mb-0"><?php echo e($gs->address); ?></p>
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="info-card p-4 shadow-sm border-0 d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <p class="small text-muted mb-0"><?php echo e($gs->phone); ?></p>
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="info-card p-4 shadow-sm border-0 d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <p class="small text-muted mb-0"><?php echo e($gs->email); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card border-0 shadow-lg p-4 p-md-5" style="border-radius: 25px; background: #fff;">
                        ...
                        <?php if(Session::has('success')): ?>
                            <div class="alert alert-success border-0 shadow-sm py-3 mb-4" style="background: #28a745; color: #fff; border-radius: 12px;">
                                <i class="fas fa-check-circle me-2 font-weight-bold"></i> <?php echo e(Session::get('success')); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/creativedesignbd/fraud.creativedesign.com.bd/project/resources/views/frontend/contact.blade.php ENDPATH**/ ?>