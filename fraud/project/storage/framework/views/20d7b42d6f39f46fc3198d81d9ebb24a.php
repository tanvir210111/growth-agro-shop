...
<?php $__env->startSection('meta'); ?>
    ...
    <title><?php echo e(__('Price Plan')); ?> - <?php echo e($gs->title); ?></title>
    ...
    <meta name="author" content="<?php echo e(__('Service')); ?> - <?php echo e($gs->title); ?>">
    <link rel="canonical" href="<?php echo e(url()->current()); ?>">

    
    <meta property="og:title" content="<?php echo e(__('Price Plan')); ?> - <?php echo e($gs->title); ?>" />
    ...
    <meta property="og:site_name" content="<?php echo e(__('Price Plan')); ?> - <?php echo e($gs->title); ?>" />

    
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="<?php echo e(__('Price Plan')); ?> - <?php echo e($gs->title); ?>">
        ...
        <div class="container">
            <div class="row g-4 justify-content-center align-items-stretch">
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    ...
                    <div class="card pricing-card h-100 border-0 shadow-lg text-center position-relative <?php echo e($pricing->is_featured == 1 ? 'featured-card' : ''); ?>" style="border-radius: 25px; transition: 0.4s; background: #fff;">
                        
                        
                        <?php if($pricing->is_featured == 1): ?>
                            <div class="popular-badge">BEST VALUE</div>
                        <?php endif; ?>

                        <div class="card-body p-4 p-md-5 d-flex flex-column">
                            <h3 class="fw-bold mb-3 text-dark"><?php echo e($pricing->title); ?></h3>
                            ...
                            <div class="price-box mb-4 py-3" style="background: rgba(255, 102, 0, 0.05); border-radius: 15px;">
                                <h2 class="display-4 fw-bold mb-0" style="color: #ff6600;">
                                    <span class="fs-3"><?php echo e($pricing->currency); ?></span><?php echo e($pricing->price); ?>

                                </h2>
                                <p class="text-muted mb-0 small text-uppercase fw-bold"><?php echo e($pricing->duration); ?></p>
                            </div>
                            ...
                            <ul class="list-unstyled mb-5 text-start mx-auto w-100" style="max-width: 280px; min-height: 200px;">
                                ...
                                <?php $__currentLoopData = $feature_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <li class="mb-3 d-flex align-items-start">
                                        ...
                                        <span class="text-muted" style="font-size: 15px; line-height: 1.5;"><?php echo e(trim($feature)); ?></span>
                                    </li>
                                    <?php endif; ?>
                            ...
                            <div class="mt-auto">
                                ...
                                <a href="<?php echo e($pricing->order_link ?? route('login')); ?>" target="_blank" 
                                   class="btn btn-lg w-100 py-3 fw-bold <?php echo e($pricing->is_featured == 1 ? 'text-white shadow orange-active-btn' : 'shadow-sm blue-outline-btn'); ?>">
                                    <?php echo e($pricing->is_featured == 1 ? 'এখনই কিনুন' : 'অর্ডার করুন'); ?>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 text-center">
                    <div class="p-5 shadow-sm rounded-4 border">
                        ...
                        <a href="<?php echo e(url('/contact')); ?>" class="btn btn-outline-dark btn-lg px-5 rounded-pill fw-bold">যোগাযোগ করুন</a>
                    </div>
                </div>
            </div>
        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/creativedesignbd/fraud.creativedesign.com.bd/project/resources/views/frontend/priceing.blade.php ENDPATH**/ ?>