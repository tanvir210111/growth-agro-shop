        ...
        <div class="login-form-side">
            ...
            <form action="{{ route('front.login') }}" method="POST">
                ...
                <div class="modern-input-group">
                    {{-- লেবেল পরিবর্তন করা হয়েছে --}}
                    <label>ইমেইল অথবা মোবাইল নাম্বার</label>
                    
                    {{-- ইনপুট নেম 'email' রাখা হয়েছে যাতে কন্ট্রোলার এরর না দেয়, কিন্তু টাইপ 'text' যাতে ফোন নাম্বারও লেখা যায় --}}
                ...
                <a href="{{ route('user.forgot.password') }}" class="forgot-link">পাসওয়ার্ড ভুলে গেছেন?</a>
        ...
        <div class="modal-content border-0" style="border-radius: 15px;">
            ...
            <div class="modal-body p-4">
                ...
                <form action="{{ route('front.register') }}" method="POST">
                    ...
                    {{-- ইমেইল (Optional -> Required করা হলো) --}}
                    <div class="modern-input-group mb-3">
