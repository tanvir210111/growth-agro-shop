...
@section('meta')
    <title>{{ $gs->title ?? 'BD Courier' }} — কাস্টমার ভেরিফিকেশন ও রিস্ক চেক</title>
    ...
    <meta property="og:title" content="{{ $gs->title ?? 'BD Courier' }} — Fraud Checker" />
    <meta property="og:image" content="{{ asset('assets/images/logo/'.($gs->og_baner ?? '')) }}" />
@endsection
    ...
    <div class="container">
        <div class="hero-grid">
            <div class="hero-copy">
                ...
                <div class="hero-btns">
                    <a href="{{ $startUrl }}" class="btn-hero-primary"><i class="fas fa-search"></i> ফ্রি সার্চ করুন</a>
                    <a href="{{ $startUrl }}" class="btn-hero-outline">অ্যাকাউন্ট খুলুন <i class="fas fa-arrow-right"></i></a>
                </div>
            </div>
    ...
    <div class="container">
        ...
        <div class="logo-row">
            ...
            @foreach($couriers as $c)
                @php $src = asset('assets/front/img/bd/'.$c['file']); @endphp
                @if(file_exists(base_path('../assets/front/img/bd/'.$c['file'])) && filesize(base_path('../assets/front/img/bd/'.$c['file'])) > 500)
                    <img class="clogo" src="{{ $src }}" alt="{{ $c['name'] }}">
                @else
...
<section class="sec sec-soft">
    <div class="container">
        <div class="head reveal">
            ...
            <p>{{ $gs->title ?? 'BD Courier' }} দিয়ে অর্ডার কনফার্মের আগেই কাস্টমার যাচাই করুন</p>
        </div>
            ...
            <article class="card-win">
                <div class="card-top">
                    ...
                    <div>
                        ...
                        <h3>{{ $gs->title ?? 'BD Courier' }} দিয়ে বাঁচান</h3>
                    </div>
                </div>
                <div class="win-item">
                ...
                <a href="{{ $startUrl }}" class="btn btn-primary btn-md win-cta">শুরু করুন <i class="fas fa-arrow-right"></i></a>
            </article>
        </div>
...
<section class="sec sec-soft" id="how" style="background:#f8fafc">
    <div class="container">
        ...
        <div class="text-center mt-5 reveal">
            <a href="{{ $startUrl }}" class="btn btn-primary btn-lg">ফ্রি অ্যাকাউন্ট খুলুন <i class="fas fa-arrow-right"></i></a>
            ...
            <div class="free-inner">
                <div>
                    ...
                    <div class="d-flex flex-wrap gap-3">
                        <a href="{{ $startUrl }}" class="btn btn-white btn-lg"><i class="fas fa-rocket"></i> ফ্রি অ্যাকাউন্ট খুলুন</a>
                        <a href="{{ url('/priceing') }}" class="btn btn-ghost-w btn-lg">সব প্ল্যান দেখুন <i class="fas fa-arrow-right"></i></a>
                    </div>
...
<section class="sec sec-soft" id="contact">
    <div class="container">
        ...
        <div class="contact2 reveal">
            <a class="ccard wa" href="https://wa.me/88{{ $phone }}" target="_blank" rel="noopener">
                <div class="ico"><i class="fab fa-whatsapp"></i></div>
                <h3>WhatsApp</h3>
                <p class="sub">সবচেয়ে দ্রুত রেসপন্স</p>
                <p class="num">{{ $gs->phone ?? '01772411171' }}</p>
                <span class="go">মেসেজ করুন <i class="fas fa-arrow-right"></i></span>
            </a>
            <a class="ccard call" href="tel:+88{{ $phone }}">
        ...
        <div class="meta-row reveal">
            ...
            <div class="mcard">
                ...
                <span>{{ $gs->email ?? 'support@bdcourier.com' }}</span>
            </div>
            <div class="mcard">
                <b><i class="fas fa-map-marker-alt"></i> অফিস</b>
                <span>{{ $gs->address ?? 'Dhaka, Bangladesh' }}</span>
            </div>
        </div>
    </div>
</section>
