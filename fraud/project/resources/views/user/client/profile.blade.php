...
<section class="ud-wrap">
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    <div class="user-avatar-wrapper m-0" style="width: 70px; height: 70px;">
                                        <img id="avatar-preview-small" src="{{ Auth::user()->photo ? asset('assets/images/users/'.Auth::user()->photo) : 'https://cdn-icons-png.flaticon.com/512/149/149071.png' }}" class="user-avatar">
                                    </div>
    ...
    <textarea name="address" class="form-control" rows="2" placeholder="আপনার পূর্ণ ঠিকানা লিখুন">{{ Auth::user()->address }}</textarea>
</div>
                        </div>
                    </div>
